...
import entity.TinhTrangSanPham;
...
public class ChiTietHoaDon_dao implements ChiTietHoaDon_Interface{
    ...
    try {
        ...
        while (rs.next()) {
            ...
            KichThuoc kichthuoc = KichThuoc.valueOf(rs.getString("kichThuoc"));
            MauSac mausac = MauSac.valueOf(rs.getString("mauSac"));
            double dongia = rs.getDouble("donGia");
            int sl = rs.getInt("soLuong");
            TinhTrangSanPham tinhtrang = TinhTrangSanPham.valueOf(rs.getString("tinhTrang"));
